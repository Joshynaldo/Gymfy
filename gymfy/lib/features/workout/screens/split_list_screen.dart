...
///
/// A separate screen from the Workout tab on purpose. The tab answers "what am I
/// training?" and only ever shows the active split; this screen answers "which
/// programmes do I have?", which is a rarer question and shouldn't sit between
...
/// Prompts for a split name and creates it. Does nothing if cancelled.
///
/// Shared with the Workout tab, which offers the same action from its empty
/// state and its split switcher.
